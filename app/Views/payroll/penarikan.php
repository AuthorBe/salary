    ...
    <div class="d-flex align-items-start">
        ...
        <div>
            ...
            <p class="mb-1 text-secondary">
                <span class="badge bg-warning-subtle text-warning me-1">Belum Dipotong</span> 
            ...
            <p class="mb-0 text-secondary">
                <span class="badge bg-success-subtle text-success me-1">Sudah Dipotong</span> 
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
        <form method="GET" action="<?= url('/payroll/penarikan') ?>" class="row g-2 align-items-center">
            <div class="col-auto">
                <select name="status" class="form-select form-select-sm rounded-pill" onchange="this.form.submit()">
                    <option value="">Semua Status</option>
                    <option value="pending" <?= $statusFilter === 'pending' ? 'selected' : '' ?>>Belum Dipotong Penggajian</option>
                    <option value="applied" <?= $statusFilter === 'applied' ? 'selected' : '' ?>>Sudah Dipotong Penggajian</option>
                </select>
            </div>
        </form>
    </div>
